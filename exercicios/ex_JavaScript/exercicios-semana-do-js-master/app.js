...
// const oddNumbers = randomNumbers.filter(function(randomNumber) {
//   if (randomNumber % 2 != 0) {
//     return randomNumber
//   }
// })
...
const lessThan501 = crazyNumbers.reduce((accumulator, crazyNumber) => crazyNumber < 501 ? accumulator + 1 : accumulator, 0)
...
// const oldMovies = tarantinoMovies.filter((movie) => {
//   if (movie.release < 2000) {
//     return movie
//   }
// })

const oldMovies = tarantinoMovies.filter(movie => movie.release < 2000)
...
const showNames = tvShows.map(show => show.name)
...
const productList = cart
  .reduce((accumulator, product) => `${accumulator}- ${product.name} \n`, '')
