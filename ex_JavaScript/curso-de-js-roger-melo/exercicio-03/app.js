...
const initials = `${dogNames[0][0]}${dogNames[1][0]}${dogNames[3][0]}`
...
const dessert = `${dogNames[0].slice(-2)}${dogNames[1].slice(-2)}${dogNames[3].slice(-2)}`.replace('n', 'd')
