...
// https://pullanswer.com/questions/resumo-da-aula-template-strings-aula-02-06-e-exercicios-02-da-etapa-01
...
let newName = name[0].toUpperCase() + name.slice(1, 6) + ' ' + name[7].toLocaleUpperCase() + name.slice(8,12)
...
newName = `${name[0].toUpperCase() + name.slice(1, 5)} ${name[7].toUpperCase() + name.slice(8)}`
